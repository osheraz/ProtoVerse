...
class RobotState:
    ...
    def convert_to_common(self, conversion: DataConversion) -> "RobotState":
        ...
        new_dof_pos = (
            self.dof_pos[:, conversion.dof_convert_to_common]
            if self.dof_pos is not None
            else None
        )
        new_dof_vel = (
        ...
        new_rigid_body_pos = (
            self.rigid_body_pos[:, conversion.body_convert_to_common]
            if self.rigid_body_pos is not None
            else None
        )
        ...
        new_rigid_body_vel = (
            self.rigid_body_vel[:, conversion.body_convert_to_common]
            if self.rigid_body_vel is not None
            else None
        )
        new_rigid_body_ang_vel = (
            self.rigid_body_ang_vel[:, conversion.body_convert_to_common]
            if self.rigid_body_ang_vel is not None
            else None
        )
    ...
    def convert_to_sim(self, conversion: DataConversion) -> "RobotState":
        ...
        new_dof_pos = (
            self.dof_pos[:, conversion.dof_convert_to_sim]
            if self.dof_pos is not None
            else None
        )
        new_dof_vel = (
        ...
        new_rigid_body_pos = (
            self.rigid_body_pos[:, conversion.body_convert_to_sim]
            if self.rigid_body_pos is not None
            else None
        )
        new_rigid_body_rot = None
        ...
        new_rigid_body_vel = (
            self.rigid_body_vel[:, conversion.body_convert_to_sim]
            if self.rigid_body_vel is not None
            else None
        )
        new_rigid_body_ang_vel = (
            self.rigid_body_ang_vel[:, conversion.body_convert_to_sim]
            if self.rigid_body_ang_vel is not None
            else None
        )

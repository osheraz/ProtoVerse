...
from protomotions.utils.logging import HydraLoggerBridge
import logging
...
# python protomotions/eval_agent.py +robot=g1 +simulator=isaaclab  checkpoint=results/g1_steering/last.ckpt

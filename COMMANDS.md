...
HYDRA_FULL_ERROR=1 python protoverse/train_agent.py +experiment_name=g1_path +robot=g1 +exp=path_follower_mlp +simulator=isaacgym ++env.config.enable_height_termination=true +opt=wandb

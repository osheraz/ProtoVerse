...
HYDRA_FULL_ERROR=1 python protoverse/train_agent.py +experiment_name=g1_sim_offc +robot=g1_29dof_anneal_23dof +exp=steering_mlp +simulator=isaaclab ++env.config.enable_height_termination=true +opt=wandb

...
HYDRA_FULL_ERROR=1 python protoverse/train_agent.py +experiment_name=h1_curr +robot=h1 +exp=steering_mlp +simulator=isaaclab ++env.config.enable_height_termination=true +opt=wandb

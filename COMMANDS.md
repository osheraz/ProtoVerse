...
HYDRA_FULL_ERROR=1 python protoverse/train_agent.py +robot=g1_29dof_anneal_23dof +exp=steering_mlp +simulator=isaaclab ++env.config.enable_height_termination=true +opt=wandb +experiment_name=g23_off_sim3

...
# python protoverse/train_agent.py +experiment_name=h1_slow +exp=steering_mlp +robot=h1 +simulator=isaaclab +opt=wandb ++env.config.enable_height_termination=true

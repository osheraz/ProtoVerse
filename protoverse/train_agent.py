...
# python protoverse/train_agent.py +exp=steering_mlp +robot=h1 +simulator=isaaclab +experiment_name=h1_steering_terrain +opt=wandb ++env.config.enable_height_termination=true

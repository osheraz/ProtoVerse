...
from protoverse.utils.device_dtype_mixin import DeviceDtypeModuleMixin
...
# CT hack: remap phys_anim to protoverse for backwards compatibility of pre-existing motion files
import sys
import protoverse

sys.modules["phys_anim"] = protoverse

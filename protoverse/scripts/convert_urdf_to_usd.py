...
def main():
    ...
    usd_stage = Usd.Stage.Open(str(urdf_converter.usd_path))
    usda_path = str(urdf_converter.usd_path).replace(".usd", ".usda")
    usd_stage.Export(usda_path)
    print(f"Also exported as ASCII USDA: {usda_path}")
